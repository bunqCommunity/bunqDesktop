...
export async function registrationLogin(
    BunqJSClient,
    derivedPassword,
    apiKey = false,
    deviceName,
    ...
    return async dispatch => {
        ...
        const failedLoadingMessage = window.t("We failed to load the stored API key Try again or re-enter the key");
        ...
        try {
            ...
            dispatch(openModal(error1, errorTitle));
            throw exception;
        }
