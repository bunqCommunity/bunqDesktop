...
const mapDispatchToProps = (dispatch: AppDispatch) => {
    return {
        ...
        removeCategoryConnection: (...params) => dispatch(categoriesActions.removeCategoryConnection(...params)),
        setCategory: (...params) => dispatch(categoriesActions.setCategory(...params))
    };
};
