    ...
    render() {
        ...
        const settingsContainer = (
            <Grid container spacing={16}>
                ...
                <Grid item xs={6} md={3} lg={2}>
                    <Button variant="outlined" color="secondary" style={styles.button as CSSProperties} onClick={this.clearPrivateData}>
                        {t("Remove keys")} <RemoveIcon />
                    </Button>
                </Grid>

                <Grid item xs={6} md={3} lg={2}>
                    <Button variant="outlined" color="primary" style={styles.button as CSSProperties} onClick={this.logout}>
                        {t("Logout")} <LogoutIcon />
                    </Button>
                </Grid>
        ...
        const dataManagementContainer = (
            <Grid container spacing={16}>
                ...
                <Grid item xs={12} sm={4}>
                    <Button variant="outlined" style={styles.button as CSSProperties} onClick={this.props.paymentsClear}>
                        {t("Regular payments")} {paymentCount}
                    </Button>
                </Grid>

                <Grid item xs={12} sm={4}>
                    <Button variant="outlined" style={styles.button as CSSProperties} onClick={this.props.masterCardActionsClear}>
                        {t("Card payments")} {cardPaymentCount}
                    </Button>
                </Grid>

                <Grid item xs={12} sm={4}>
                    <Button variant="outlined" style={styles.button as CSSProperties} onClick={this.resetRequestData}>
                        {t("Requests")} {requestCount}
                    </Button>
                </Grid>

                <Grid item xs={12} sm={4}>
                    <Button variant="outlined" style={styles.button as CSSProperties} onClick={this.props.bunqMeTabsClear}>
                        {t("bunqme Tabs")} {bunqMeTabsCount}
                    </Button>
                </Grid>

                <Grid item xs={12} sm={4}>
                    <Button variant="outlined" style={styles.button as CSSProperties} onClick={this.requestConnectData}>
                        {t("Connect requests")} {connectCount}
                    </Button>
                </Grid>

                <Grid item xs={12} sm={4}>
                    <Button variant="outlined" style={styles.button as CSSProperties} onClick={this.props.scheduledPaymentsClear}>
...
const mapDispatchToProps = (dispatch, ownProps) => {
    ...
    return {
        ...
        bunqMeTabsClear: () => dispatch(bunqMeTabsActions.clear()),
