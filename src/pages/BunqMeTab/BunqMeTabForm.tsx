...
import { bunqMeTabSend } from "~store/bunqMeTab/thunks";
...
class BunqMeTabForm extends React.Component<any> {
    state: any;
...
export default connect(mapStateToProps, mapDispatchToProps)(translate("translations")(BunqMeTabForm));
