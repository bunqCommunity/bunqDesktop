...
export interface IProps {
    style: CSSProperties;
    deselectChip: Function;
    setCategory: Function;
    selectedCategoryId: boolean | string;
    categories: any;
    t: Function;
}
...
class CategoryEditor extends React.Component<IProps> {
    ...
    componentDidUpdate() {
        if (this.state.categoryId !== this.props.selectedCategoryId) {
            ...
            if (typeof this.props.selectedCategoryId === 'string' && this.props.categories[this.props.selectedCategoryId]) {
...
export default connect(mapStateToProps, mapDispatchToProps)(translate("translations")(CategoryEditor));
